...
@section('page-description', 'Overview of your assigned work instructions')
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <dt class="text-sm font-medium text-gray-500 truncate">Total Work Instructions</dt>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <dt class="text-sm font-medium text-gray-500 truncate">Belum Dikerjakan</dt>
        ...
        <div class="px-4 py-5 sm:p-6">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <span class="ml-1 font-medium text-gray-900">
                                            {{ $workInstruction->items->where('pivot.status', 'completed')->count() }}/{{ $workInstruction->items->count() }} completed
                                        </span>
                                    </div>
                                </div>
                                ...
                                @if($workInstruction->items->count() > 0)
                                    <div class="mt-3 pt-3 border-t border-gray-200">
                                        <h5 class="text-xs font-medium text-gray-700 mb-2">Items to {{ $workInstruction->type === 'checking' ? 'Check' : 'Take' }}:</h5>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-1">
                                            ...
                                            @if($workInstruction->items->count() > 3)
                                                <div class="text-xs text-gray-500 col-span-full text-center">
                                                    +{{ $workInstruction->items->count() - 3 }} more items
                                                </div>
                                            @endif
                                        </div>
                                    </div>
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-500">No work instructions assigned yet</p>
                </div>
            @endif
        </div>
    </div>
