...
@section('title', __('admin.items.create_title'))
@section('page-title', __('admin.items.create_title'))
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div x-data="locationPicker()">
                        ...
                        <div class="flex items-center justify-between">
                            <select id="location_select" x-ref="select" @change="syncHidden()" class="mt-1 block w-full border-gray-300 rounded-md 
                            shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"></select>
                    ...
                    <div>
                        ...
                        <input type="number" name="minimum_stock" id="minimum_stock" value="{{ old('minimum_stock', 0) }}" min="0" required
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm 
