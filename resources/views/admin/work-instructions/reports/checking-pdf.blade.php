...
<head>
    ...
    <style>
        ...
        .condition-excellent { color: #27ae60; font-weight: bold; }
        .condition-good { color: #2ecc71; font-weight: bold; }
        .condition-fair { color: #f39c12; font-weight: bold; }
        .condition-damaged_light { color: #e67e22; font-weight: bold; }
        .condition-damaged { color: #e74c3c; font-weight: bold; }
        .condition-not_found { color: #c0392b; font-weight: bold; }
            ...
            <tr>
                ...
                <td>
                    @if($item->pivot->condition)
                        <span class="condition-{{ $item->pivot->condition }}">
                            {{ ucfirst(str_replace('_', ' ', $item->pivot->condition)) }}
                        </span>
                    @else
                        -
                    @endif
