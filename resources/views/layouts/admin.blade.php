...
<head>
    ...
    <title>@yield('title', __('admin.dashboard.title')) - {{ __('app.name') }}</title>
    ...
    <div class="min-h-screen flex">
        ...
        >
            <div class="p-4 border-b border-gray-700">
                ...
                <p class="text-gray-400 text-sm mt-1">{{ __('nav.admin_panel') }}</p>
            ...
            <nav class="flex-1 mt-4 px-2 overflow-y-auto pb-4">
                ...
                <div class="px-4 py-2 mt-2 text-gray-400 text-xs font-semibold uppercase tracking-wider">{{ __('nav.report_details') }}</div>
                ...
                <div class="px-4 sm:px-6 py-4">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-3 min-w-0 flex-1">
                            ...
                            <div class="min-w-0">
                            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900 break-words">@yield('page-title', __('admin.dashboard.page_title'))</h1>
                            <p class="text-xs sm:text-sm text-gray-500 mt-1 break-words">@yield('page-description', __('layout.default_desc_admin'))</p>
                            </div>
                        </div>
